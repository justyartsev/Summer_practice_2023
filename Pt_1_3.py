...
print(max(first_number, second_number, third_number), first_number + second_number + third_number
      - max(first_number, second_number, third_number) - min(first_number, second_number, third_number)
